 ...
 */
@WebServlet("/leaveupwork/")
public class leaveupworkServlet extends BaseServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public leaveupworkServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request,
		...
		Check chk = new Check();
		ArrayList<Check> list = chk.qdchek();
		request.setAttribute("custList", list);
		request.getRequestDispatcher("/leaveupwork.jsp").forward(request,
				response);
	}
